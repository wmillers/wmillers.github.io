...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.7072630c062c93055a21ed899f21f8dbb4e51eefb046b13969f96d8fac5ff32f.js',function(){input.required=false;search();});}
