...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.4612f93154eb6ecf23d5af554ccbc8378fcd3182f89d54d335c1e2b2349edaa7.js',function(){input.required=false;search();});}
