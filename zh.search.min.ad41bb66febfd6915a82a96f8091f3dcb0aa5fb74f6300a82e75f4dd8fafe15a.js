...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.5baa0363091501ad5e733a144afbfd1cd941603e1168fd511e79d0dcebfc8ea8.js',function(){input.required=false;search();});}
