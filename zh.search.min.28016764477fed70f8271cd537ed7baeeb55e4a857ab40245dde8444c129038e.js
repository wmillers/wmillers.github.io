...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.365d5e845c4cd3cb475f8f69983db087e1ab6a803a4d0b1bc65a3359172d543c.js',function(){input.required=false;search();});}
